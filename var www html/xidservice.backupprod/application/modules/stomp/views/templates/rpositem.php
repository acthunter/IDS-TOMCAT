					...
					<form action="#" id="<?php echo $modal_id;?>_form" class="form-horizontal"> 				
						<div class="form-body">
							...
							<div class="form-group"> 
								...
								<input name="name" id="name" placeholder="Nama" class="form-control" type="text" readonly="readonly"></textarea>
							</div>
							<div class="form-group">
								<label class="control-label">Posisi</label>
								<input id="posname" name="posname" placeholder="--- Posisi ----" class="autocomplete form-control" type="text" onclick="$(this).val('');" readonly="readonly"/>   
							...
							<div class="form-group"> 
								...
								<input id="mobileNumber" name="mobileNumber" placeholder="Nomor HP" class="form-control" type="text" readonly="readonly"></textarea>
