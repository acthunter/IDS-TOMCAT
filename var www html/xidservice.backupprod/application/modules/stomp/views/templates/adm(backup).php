<script type="text/javascript">
	...
	function srch()
		{		
			//$('#dt_rp_list').dataTable({"binfo":false,"searching": false,"paging": false}).fnClearTable();
			...
			$.ajax({
				...
				tabel = $('#dt_rp_list').DataTable({ 
							...
							"order": [], 
							"ajax": {
								"url": "<?php echo site_url('stomp/xids/getadm')?>" ,
								"type": "POST",
								"dataType": "JSON",
								"data" : {'id': data['id']}
							},
	...
	<div class="modal-dialog ui-front" style="width: 85%;">
			<div class="modal-content" style="padding: 10px;">
				<div class="modal-header">
					...
					<h3 class="modal-title">Search Request by ID</h3>
				</div>
