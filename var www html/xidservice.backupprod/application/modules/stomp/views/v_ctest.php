...
<script type="text/javascript">
	var tab_myjob;	
	var form_db = {};
	var pname = {RP : "Review Position", CT: "Posisi Sementara ", CP: "Posisi Permanen", CU: "Ubah Unit", UA: "Tambah User", RS: "Reset Target", UC: "Cek User", CI: "Create Icons", UH: "Ubah No Handphone", CL: "Level Kapabilitas", CW: "Create Webmail", BN: "Add Bina Reuse" };
	...
	function action_fail(fdata){
		var text = 'Request yang dilakukan gagal. Silahkan direquest kembali';
		var type = 'error';
		new PNotify({
			title: 'Notifikasi',
			text: text,
