...
<body>
	...
	<script type="text/javascript">
		...
		function inquiry()
		{
				var url = "<?php echo site_url('stomp/xbanc/inquiry')?>" ;
				window.location=url;
		...
		function query_id()
		{
			...
			var url = "<?php echo site_url('stomp/xbanc/ubah_level')?>" ;
	...
	<!-- Bootstrap modal -->
			...
			<div class="modal-content" style="padding: 10px; width: 726px;">
				...
				<div class="modal-footer">
					...
					<button type="button" id="btnSave" onclick="query_id()" class="btn btn-primary">Ubah level</button>
					<button type="button" class="btn btn-danger" onclick="inquiry()" data-dismiss="modal">Cancel</button>
				</div>
			</div><!-- /.modal-content -->
