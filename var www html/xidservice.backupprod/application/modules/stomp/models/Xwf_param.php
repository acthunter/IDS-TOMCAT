...
class Xwf_param extends CI_Model {
	...
	private function initparam(){
		$this->wfparam = (object) array(
			"RP"=>'{"1": {"name":"review", "target":1}, "2":{"name":"approval", "target":2}, "finish": { "xreview": {"procStat": "", "status" : "P", "tflag" : "3"}, "wf":{"stage" : 2}}}',
			...
			"RS"=>'{"1": {"name":"review", "target":1}, "2":{"name":"approval", "target":2},  "finish": { "xreview": {"procStat": "P", "status" : "J", "tflag" : "3"}, "wf":{"stage" : 2}}}',
			"UC"=>'{"1": {"name":"review", "target":1}, "2":{"name":"approval", "target":2},  "finish": { "xreview": {"procStat": "P", "status" : "J", "tflag" : "3"}, "wf":{"stage" : 2}}}',
			"UH"=>'{"1": {"name":"review", "target":1}, "2":{"name":"approval", "target":2},  "finish": { "xreview": {"procStat": null, "status" : "F", "tflag" : "3"}, "wf":{"stage" : 2}}}',
			"CI"=>'{"1": {"name":"review", "target":1}, "2":{"name":"approval", "target":2},  "finish": { "xreview": {"procStat": "P", "status" : "J", "tflag" : "3"}, "wf":{"stage" : 2}}}',
			"CW"=>'{"1": {"name":"review", "target":1}, "2":{"name":"approval", "target":2},  "finish": { "xreview": {"procStat": "P", "status" : "J", "tflag" : "3"}, "wf":{"stage" : 2}}}',
			"BN"=>'{"1": {"name":"review", "target":1}, "2":{"name":"approval", "target":2},  "finish": { "xreview": {"procStat": "P", "status" : "J", "tflag" : "3"}, "wf":{"stage" : 2}}}',
			"CL"=>'{"1": {"name":"review", "target":1}, "2":{"name":"approval", "target":2},  "finish": { "xreview": {"procStat": "P", "status" : "J", "tflag" : "3"}, "wf":{"stage" : 2}}}'
		);
	}
