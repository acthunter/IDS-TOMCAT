...
class Xmod_US extends CI_Model {
	...
	public function wfaction(){
		...
		if (preg_match('/save/',$fdt['reqtype'])){
			...
			$dataarr = array('loginid'=>$fdt['loginid'], 'tpos'=>$fdt['cposid'], 'subbranch'=>$fdt['subbranch'], 'pname'=>$fdt['tposname'], 'nama'=>$fdt['nama'], 'mode'=>$fdt['mode'], 'cposname'=>$fdt['cposname'],
				'sdate'=> date('Y-m-d H:i',strtotime($sdate)), 
				'edate'=> date('Y-m-d H:i',strtotime($edate)), 
			);
			$datastr = json_encode($dataarr);
			$accoffice = $_SESSION['pengguna']->accoffice;
			$xcp = array('type'=>'US', 'accoffice'=>$accoffice,'status'=>'I',
					'data'=> $datastr);			
		...
		$dataarr = array('loginid'=>$fdt['loginid'], 'tpos'=>$fdt['cposid'],'subbranch'=>$fdt['subbranch'], 'pname'=>$fdt['tposname'], 'nama'=>$fdt['nama'], 'cposname'=>$fdt['cposname'],
			'sdate'=> date('Y-m-d H:i',strtotime($sdate)), 
			'edate'=> date('Y-m-d H:i',strtotime($edate)) 
		);
