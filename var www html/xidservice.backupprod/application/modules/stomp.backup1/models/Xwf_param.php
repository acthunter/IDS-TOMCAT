...
class Xwf_param extends CI_Model {
	...
	private function initparam(){
		$this->wfparam = (object) array(
			...
			"US"=>'{"1": {"name":"review", "target":1}, "2":{"name":"approval", "target":2},  "finish": { "xreview": {"procStat": "P", "status" : "J", "tflag" : "3"}, "wf":{"stage" : 2}}}',
			"VL"=>'{"1": {"name":"review", "target":1}, "2":{"name":"approval", "target":2},  "finish": { "xreview": {"procStat": "P", "status" : "J", "tflag" : "3"}, "wf":{"stage" : 2}}}',
			"SC"=>'{"1": {"name":"review", "target":1}, "2":{"name":"approval", "target":2},  "finish": { "xreview": {"procStat": "P", "status" : "J", "tflag" : "3"}, "wf":{"stage" : 2}}}',
