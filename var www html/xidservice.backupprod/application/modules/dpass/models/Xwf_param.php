...
class Xwf_param extends CI_Model {
	...
	private function initparam(){
		$this->wfparam = (object) array(
			...
			"RS"=>'{"1": {"name":"review", "target":1}, "2":{"name":"approval", "target":2},  "finish": { "xreview": {"procStat": "P", "status" : "I", "tflag" : "3"}, "wf":{"stage" : 2}}}',
			"UC"=>'{"1": {"name":"review", "target":1}, "2":{"name":"approval", "target":2},  "finish": { "xreview": {"procStat": "P", "status" : "I", "tflag" : "3"}, "wf":{"stage" : 2}}}'
		);
	}
