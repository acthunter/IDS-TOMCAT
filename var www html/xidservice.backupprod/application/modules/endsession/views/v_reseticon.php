<script type="text/javascript">
	...
	function bc_submit(stype){
		...
		function verification(){
			...
			var fdata = {'reqtype': 'resetPass', 'npp' : $("#npp").val(), 'terminal' : $("#terminal").val(), 'target' : 'banc' , 'delivery': 'online'};
			...
			$.ajax({
				...
				success: function(data)
				{
					...
					//alert('testing');
					if (data.resp.match(/ok.*/)){
						new PNotify({
							title: 'Notifikasi',
							text: 'kill user berhasil',
							type: 'success',
							styling: 'bootstrap3'
						});
					} else{
...
<div id="wrapper">
		...
		<form action="#" style="width: 500px; margin: auto;">
			...
			<div class="form-group row">
				<p>
					<label>NPP</label> 	
					<input name="npp" id="npp" placeholder="-- NPP --" type="text" onclick="$(this).val('');">
				</p>
				<p>
