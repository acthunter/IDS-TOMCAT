...
<body>
	<center><h2 style="padding-bottom: 10px;">Audit</h2></center>
...
<script type="text/javascript">
	...
	$(document).ready(function() { 
		...
		tab = $('#dt_audit').DataTable({
			...
			"ajax": {
			"url": "<?php echo site_url('sysadm/xbatch/audit_list')?>",
			"type": "POST"
			},
			"columns": [
